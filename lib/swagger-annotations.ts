 ...
 *     description: Retrieve educational resources with pagination
 *     parameters:
 *       - in: query
 *         name: category
 *         schema:
 ...
 *         description: Validation error
 *       403:
 *         description: Unauthorized or invalid lesson
 *       409:
 ...
 *     description: System admin endpoint to retrieve all users
 *     security:
 *       - cookieAuth: []
 *       - bearerAuth: []
 *     parameters:
 ...
 *       403:
 *         description: Unauthorized - System admin only
 */
 ...
 *     description: System admin endpoint for platform metrics and statistics
 *     security:
 *       - cookieAuth: []
 *       - bearerAuth: []
 *     responses:
